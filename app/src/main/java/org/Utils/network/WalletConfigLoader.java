...
public class WalletConfigLoader extends AsyncTask<Void, Void, String> {
    ...
    private Callbacks.StringCallback onFinishCallback;

    public static void loadConfig(String url, Callbacks.StringCallback callback) {
        new WalletConfigLoader(url, callback).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, null, null, null);
    }

    public WalletConfigLoader(String url, Callbacks.StringCallback callback) {
        super();
        currentUrl = url;
