...
public class SettingsCheckCell extends FrameLayout {

    private TextView textView;
    private CheckBoxSquare checkBox;
    private boolean needDivider;

    public SettingsCheckCell(Context context) {
        this(context, false, false);
    }

    public SettingsCheckCell(Context context, boolean dialog, boolean revereLayout) {
        super(context);
