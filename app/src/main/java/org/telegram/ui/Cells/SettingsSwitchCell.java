...
public class SettingsSwitchCell extends FrameLayout {
    ...
    public static final Property<SettingsSwitchCell, Float> ANIMATION_PROGRESS = new AnimationProperties.FloatProperty<SettingsSwitchCell>("animationProgress") {
        @Override
        public void setValue(SettingsSwitchCell object, float value) {
            object.setAnimationProgress(value);
            object.invalidate();
        }

        @Override
        public Float get(SettingsSwitchCell object) {
    ...
    public SettingsSwitchCell(Context context, int padding) {
        this(context, padding, false);
    }

    public SettingsSwitchCell(Context context, int padding, boolean dialog) {
        super(context);
    ...
    public void setTextAndCheck(String text, boolean checked, boolean divider) {
        setTextAndCheck((CharSequence) text, checked, divider);
    }
