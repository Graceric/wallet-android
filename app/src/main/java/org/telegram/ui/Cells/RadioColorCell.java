...
public class RadioColorCell extends FrameLayout {
    ...
    public RadioColorCell(Context context) {
        ...
        radioButton.setColor(Theme.getColor(Theme.key_dialogTextGray3), Theme.getColor(Theme.key_wallet_defaultTonBlue));
        ...
        text2View.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText));
