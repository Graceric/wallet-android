...
public class Switch extends View {
    ...
    private String trackColorKey = Theme.key_divider;
    private String trackCheckedColorKey = Theme.key_wallet_defaultTonBlue;
    ...
    public void setDrawRipple(boolean value) {
        ...
        if (isChecked && colorSet != 2 || !isChecked && colorSet != 1) {
            int color = isChecked ? Theme.getColor(Theme.key_wallet_defaultTonBlue) : Theme.getColor(Theme.key_divider);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int width = AndroidUtilities.dp(32);
